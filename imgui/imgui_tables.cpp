...
static const float TABLE_RESIZE_SEPARATOR_FEEDBACK_TIMER = 0.06f;   // Delay/timerThread before making the hover feedback (color+cursor) visible because tables/columns tends to be more cramped.
...
// - Set table->HoveredColumnBorder with a short delay/timerThread to reduce feedback noise
